                            ...
                            <div class="post">
                                <div class="post-bgtop">
                                    <div class="post-bgbtm">
                                        ...
                                        %>
                                        <h1 class="title">Bienvenido al asistente para consultar Datos Espaciales</h1>
                                        <p class="meta"></p>
                                        <div class="entry">
                                            <br><br><br><br>
                                            <p>Por favor elija una opcion del menú
                                                presentado a la izquierda, si lo que desea<br>
                                                es consultar un mapa existente en el sistema
                                                elija laopción "Agregar Plano", de esta forma usted<br>
                                        ...
                                        <sql:transaction dataSource="${bdatos}">
                                            ...
                                            <h1 class="title">Consultar Mapa</h1>
                                            <p class="meta"></p>
                                            <html:form action="/consultarMapa" method="post" enctype="multipart/form-data">
                                                <font color=”red”><html:errors/></font>
                                                Seleccione el Mapa que desea visualizar<br>
                                                <select name="name">
                                                ...
                                                <html:submit>Consultar Mapa</html:submit>
                        ...
                        <div id="sidebar">
                            <ul>
                                <li>
                                    <h2>Opciones</h2>
                                    <ul>
                                        <li><a href="consultar.jsp?accion=mapa">Consultar Mapa</a><span>Agregue un nuevo plano al sistema</span></li>
                                    </ul>
                                </li>
